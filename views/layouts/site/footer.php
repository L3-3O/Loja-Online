        ...
        <div class="container">
            <div class="row g-4 mb-4">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="d-flex gap-3 fs-5">
                        ...
                        <a href="https://twitter.com" class="text-white" aria-label="Twitter"><i class="bi bi-twitter-x"></i></a>
            ...
            <div class="row align-items-center small  pt-2">
                ...
                <div class="col-md-3 text-center mb-3 mb-md-0">
                    <span class="d-inline-block me-2"><i class="bi bi-credit-card fs-5"></i></span>
                    <span class="d-inline-block me-2"><i class="bi bi-wallet2 fs-5"></i></span>
                    <span class="d-inline-block"><i class="bi bi-shield-lock-fill text-success fs-5"></i> <small class="text-white">Ambiente Seguro</small></span>
                </div>
                <div class="col-md-3 text-center text-md-end">
                    <span class="text-white"><i class="bi bi-shield-check text-success me-1"></i> Site Protegido</span>
                </div>
            </div>
        </div>
    </footer>